...
TEMPLATES_DIR = os.path.join(BASE_DIR_1,'templates')
STATICFILES_DIR = os.path.join(BASE_DIR_1,'static')
...
SECRET_KEY = 'django-insecure-6ne*wj0)dqk+i)m7i47476*ro%o7$2y3fhtp7z=lnx(bcb+ckj'
